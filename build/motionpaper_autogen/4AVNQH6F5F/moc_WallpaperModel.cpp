...
namespace {
struct qt_meta_stringdata_WallpaperModel_t {
    uint offsetsAndSizes[2];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WallpaperModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WallpaperModel_t qt_meta_stringdata_WallpaperModel = {
    {
        QT_MOC_LITERAL(0, 14)   // "WallpaperModel"
    },
    "WallpaperModel"
};
...
Q_CONSTINIT static const uint qt_meta_data_WallpaperModel[] = {
...
Q_CONSTINIT const QMetaObject WallpaperModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_WallpaperModel.offsetsAndSizes,
    qt_meta_data_WallpaperModel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WallpaperModel_t,
        // Q_OBJECT / Q_GADGET
...
void *WallpaperModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WallpaperModel.stringdata0))
